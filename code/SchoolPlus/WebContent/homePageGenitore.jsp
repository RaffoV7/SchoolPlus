...
<jsp:include page="navbarGenitore.jsp"></jsp:include>
		...
		<div class="col-md-4">
			<div class="card" style="margin: 2em;">
				<h4 class="card-header">Guido Mista</h4>
				...
				<div class="card-body">
					<p class="card-text">
						<span class="font-weight-bold">Alunno: </span>Guido Mista
					</p>
					
				<p class="card-text">
						<span class="font-weight-bold">Classe: </span>2^A
					</p>
					<p class="card-text">
						<span class="font-weight-bold">Istituto: </span>Liceo de
						Chirico
					</p>
